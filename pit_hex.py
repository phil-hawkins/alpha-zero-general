...
flags.DEFINE_string('cpu1_checkpoint', 'base_cnn/hex7x7_cnn1.tar', 'pretrained weights for computer player 1')
flags.DEFINE_string('cpu2_checkpoint', 'base_cnn/hex7x7_cnn1.tar', 'pretrained weights for computer player 2')
