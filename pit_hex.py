...
flags.DEFINE_string('cpu1_checkpoint', 'base_cnn/best.pth.tar', 'pretrained weights for computer player 1')
flags.DEFINE_string('cpu2_checkpoint', 'base_cnn/best.pth.tar', 'pretrained weights for computer player 2')
