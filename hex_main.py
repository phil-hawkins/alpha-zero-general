...
flags.DEFINE_float('start_temp', 3.0, 'network learning rate')
flags.DEFINE_integer('tempThreshold', 30, 'temp=1 if episodeStep < tempThreshold, and thereafter uses temp=0')
